...
def make_excetue_handlers(key, metadata=None):
    execute_handlers = {
        ...
        'count': count_handler,
        'query_color': make_query_handler('color', is_part=None),
        'query_shape': make_query_handler('shape', is_part=False),
        'query_partname': make_query_handler('partname', is_part=True),
        'query_material': make_query_handler('material', is_part=None),
        'query_size': make_query_handler('size', is_part=None),
        'exist': exist_handler,
